...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title">Sửa khoản chi</h3>
        </div>
    </div>
</div>
<div class="m-content">
            ...
            <div class="m-portlet m-portlet--tab">
                ...
                <form id="form_data" method="POST" action='{{ route("save_expense.admin") }}' class="m-form m-form--state m-form--fit m-form--label-align-right form-ajax">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <input type="hidden" name="edit_id" value="{{$expense_detail->id}}">
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <input id="amount" value="{{$expense_detail->amount}}" name="amount" placeholder="Số tiền chi" autocomplete="off" class="form-control m-input" type="text" />
                            </div>
                        </div>
                        ...
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <select class="form-control m-select2" id="expense_purpose" name="expense_purpose">
                                    ...
                                    <option {{selected($itm->id,$expense_detail->config_id)}} value="{{$itm->id}}">{{$itm->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <textarea class="form-control m-input m-input--air" id="note" name="note" rows="3">{!!$expense_detail->note!!}</textarea>
                            </div>
                        </div>
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <div class="input-group date">
                                    <input value="{{$expense_detail->date_string}}" type="text" class="form-control m-input" readonly placeholder="Select date & time" name="expense_date" id="expense_date" />
                        ...
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <select class="form-control m-select2" id="expense_user" name="expense_user">
                                    <option></option>
                                    @foreach($user as $itm)
                                    <option {{selected($itm->id,$expense_detail->user_id)}} value="{{$itm->id}}">{{$itm->username}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <label class="m-checkbox">
                                    <input name="is_refund" id="is_refund" {{$expense_detail->is_refund ? "checked" : ""}} class="form-control m-input" type="checkbox">
                                    Đã hoàn tiền
                                    <span></span>
                                </label>
                            </div>
