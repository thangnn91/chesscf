            ...
            <div class="m-portlet m-portlet--tab">
                ...
                <form id="form_data" method="POST" action='{{ route("save_income.admin") }}' class="m-form m-form--state m-form--fit m-form--label-align-right form-ajax">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <input type="hidden" name="edit_id" value="{{$income_detail->id}}">
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <input id="amount" value="{{$income_detail->amount}}" name="amount" placeholder="Số tiền chi" autocomplete="off" class="form-control m-input" type="text" />
                            </div>
                        </div>
                        ...
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <select class="form-control m-select2" id="income_purpose" name="income_purpose">
                                    ...
                                    <option {{selected($itm->id,$income_detail->config_id)}} value="{{$itm->id}}">{{$itm->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <textarea class="form-control m-input m-input--air" id="note" name="note" rows="3">{!!$income_detail->note!!}</textarea>
                            </div>
                        </div>
                        <div class="form-group m-form__group m-form__group-sub row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <div class="input-group date">
                                    <input value="{{$income_detail->date_string}}" type="text" class="form-control m-input" readonly placeholder="Select date & time" name="income_date" id="income_date" />
