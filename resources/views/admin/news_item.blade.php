    ...
    <div class="row">
        <div class="col-md-12">
            <div class="m-portlet m-portlet--tab">
                ...
                <!--begin::Form-->
                <form id="main_form" role="form" method="POST" action='{{ route("save_news.admin") }}' class="m-form m-form--fit m-form--label-align-right">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input autocomplete="off" type="text" class="form-control m-input m-input--square" name="title" id="title" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group m-form__group">
                            <div class="m-checkbox-inline">
                                <label class="m-checkbox">
                                    <input id="is_hot" name="is_hot" type="checkbox"> Tin hot
                                    <span></span>
                                </label>
                                <label class="m-checkbox">
                                    <input id="is_new" name="is_new" type="checkbox"> Tin mới
                                    <span></span>
                                </label>
                            </div>
                        </div>
